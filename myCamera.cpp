...
mySegment myCamera::constructRay(int x, int y, bool normalize) const
{
	...
	//added for use in canvus code, not sure of it.
	if (normalize) ray.p2 = ray.p1 + 100.0f * (ray.p2 - ray.p1);
